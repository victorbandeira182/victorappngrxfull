...
export class UpdateTarefaAction implements Action {
...
export class UpdateTarefaSuccessAction implements Action {
  readonly type = UPDATE_TAREFA_SUCCESS;
}

export class UpdateTarefaFailAction implements Action {
...
export type TarefaActionsTypes =
  ...
  | GetTarefaFailAction
  | UpdateTarefaAction
  | UpdateTarefaSuccessAction
  | UpdateTarefaFailAction
  | DeleteTarefaAction
